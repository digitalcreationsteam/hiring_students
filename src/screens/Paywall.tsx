...
//       // Step 4: Get updated navigation status (after subscription created)
...
//       // Step 5: Update Redux with new navigation
//       dispatch(
//         setNavigation({
...
//                         className="group cursor-pointer w-full rounded-2xl p-6 flex flex-col gap-4 transition-all duration-300 backdrop-blur-sm hover:scale-[1.02]"
//                         style={{

...
//   const { attemptId, caseId, attemptNumber } = state || {};
...
//       const res = await API("GET", URL_PATH.getCurrentQuestion(caseId, 1));
...
//         questionText: `Question ${res.questionNumber}`, // if you want a placeholder text
...
//       await API("POST", URL_PATH.submitAnswer(caseId, question._id), {
...
//       const percent =
//         totalQuestions > 0
//           ? Math.round((newCompleted / totalQuestions) * 100)
//           : 0;
...
//   // Google Drive Fix (auto format if needed)
//   // const formattedImageUrl = question.questionImageUrl
//   //   ?.replace("/file/d/", "/uc?export=view&id=")
//   //   ?.replace("/view?usp=sharing", "");


//   // const formattedImageUrl = question.questionImageUrl
//   // ? question.questionImageUrl.includes("/d/")
//   //   ? `https://drive.google.com/uc?export=view&id=${question.questionImageUrl.match(/\/d\/(.*?)\//)?.[1]}`
//   //   : question.questionImageUrl.replace("/view?usp=sharing", "/preview") // fallback
//   // : undefined;
...
//       style={{
//         background:
//           "linear-gradient(to bottom,#d9d9d9 0%,#cfd3d6 25%,#9aa6b2 55%,#2E4056 100%)",
//       }}
//     >
//       <Navbar />
...
//             {/* Question Image */}
//             <iframe
//                               src={question.questionImageUrl.replace("/view?usp=sharing", "/preview")}
//                               width="100%"
//                               height="500"
//                               allow="autoplay"

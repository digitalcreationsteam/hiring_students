...
>
  Welcome to UniTalent: A New Data-Driven Approach To Early-Career Hiring
</span>
...
<div
  ...
  style={{
    backgroundColor: `${colors.primary}14`, // soft tint
...
>
  ...
  >
    ...
    <div className="flex h-px w-full" style={{ backgroundColor: colors.neutral[200] }} />
    ...
    <div className="flex flex-col items-start gap-4">
      ...
      <div className="flex flex-col items-start gap-3">
        ...
        <div className="flex flex-col items-start gap-3">
          {[
            { icon: FeatherBookOpen, text: "Education & coursework" },
            { icon: FeatherBriefcase, text: "Internships & work experience" },
            { icon: FeatherCode, text: "Projects & technical builds" },
            { icon: FeatherAward, text: "Certifications & training" },
            { icon: FeatherTrophy, text: "Awards & competitions" },
            { icon: FeatherUsers, text: "Leadership & campus involvement" },
          ].map(({ icon: Icon, text }) => (
        ...
        <div className="flex flex-col items-start gap-3">
          <div className="flex items-start gap-3">
            ...
            <span
              ...
              style={{ color: colors.neutral[600] }}
            >
              A short, targeted assessment built around the core tasks of desired role
            </span>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <span
              ...
              style={{ color: colors.neutral[600] }}
            >
              Evaluation based on correctness, clarity of thinking, and applied skill
            </span>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <span
              ...
              style={{ color: colors.neutral[600] }}
            >
              Standardized scoring to ensure fairness across varied educational backgrounds
            </span>
          </div>
        </div>
      </div>
  ...
  >
    ...
    <div className="flex flex-col items-start gap-4">
      <span
        ...
        style={{ color: colors.neutral[600] }}
      >
        The Hireability Index is your central score — the number that pulls together
        your skills and your hard-earned experience to show the world exactly how
        job-ready you are. It’s what determines your rank in your university, city,
        state, and across the entire country — helping recruiters instantly spot the
        best talent at the most granular level. No more getting lost in a stack of
        résumés. Your ability finally has a spotlight — with a score that proves you
        belong at the top
      </span>
        ...
        <div className="flex flex-col items-start gap-3">
          <div className="flex items-start gap-3">
            ...
            <span
              ...
              style={{ color: colors.neutral[600] }}
            >
              A weighted blend of the Skill Index and Experience Index
            </span>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <span
              ...
              style={{ color: colors.neutral[600] }}
            >
              Normalization to remove biases from background, institution
            </span>
          </div>
        </div>
      </div>
  ...
  <div className="flex w-full max-w-[1280px] flex-col items-start gap-12">
    <div className="flex flex-col items-start gap-4">
      ...
      <span
        ...
        style={{ color: colors.neutral[600] }}
      >
        Candidates are ranked across multi-layer cohorts within their chosen job
        role. Rankings update automatically when scores change, providing
        recruiters with granular visibility and supporting targeted talent
        discovery. This structure transitions the score framework into actionable
        hiring outcomes.
      </span>
    </div>
    ...
    >
      <div className="flex flex-col items-start gap-2">
        ...
        <span
          ...
          style={{ color: colors.neutral[600] }}
        >
          Candidates are positioned across four hierarchical levels for each job
          role
        </span>
      </div>
...
>
  <div className="mx-auto grid w-full max-w-[1024px] grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
    ...
    <div className="flex w-full flex-col gap-4 items-center sm:items-start">
      ...
      <div className="flex items-center gap-3 justify-center sm:justify-start">
        <IconButton
          icon={<FeatherTwitter />}
          style={{ color: colors.neutral[600] }}
          onClick={() => window.open("https://twitter.com/your_handle", "_blank")}
        />
        <IconButton
    ...
    <div className="flex flex-col gap-4 items-center sm:items-start">
      ...
      <span style={{ color: colors.neutral[600] }} className="text-[13px]">How It Works</span>
      <span style={{ color: colors.neutral[600] }} className="text-[13px]">Job Tracks</span>
      <span style={{ color: colors.neutral[600] }} className="text-[13px]">Rankings</span>
      <span style={{ color: colors.neutral[600] }} className="text-[13px]">Resources</span>
    </div>
    ...
    <div className="flex flex-col gap-4 items-center sm:items-start">
      ...
      <span style={{ color: colors.neutral[600] }} className="text-[13px]">Find Talent</span>
      <span style={{ color: colors.neutral[600] }} className="text-[13px]">Post Jobs</span>
      <span style={{ color: colors.neutral[600] }} className="text-[13px]">Pricing</span>
    </div>
    ...
    <div className="flex flex-col gap-4 items-center sm:items-start">
      ...
      <span style={{ color: colors.neutral[600] }} className="text-[13px]">About</span>
      <span style={{ color: colors.neutral[600] }} className="text-[13px]">Blog</span>
      <span style={{ color: colors.neutral[600] }} className="text-[13px]">Contact</span>
      <span style={{ color: colors.neutral[600] }} className="text-[13px]">Privacy</span>
    </div>

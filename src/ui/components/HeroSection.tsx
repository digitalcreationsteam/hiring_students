// src/components/HeroSection.tsx - Updated with global color variables
'use client';
        ...
        <div className="text-center">
          ...
          <div className="mb-16">
            <div className="relative inline-block">
              ...
              {/* Animated Gradient Text - Using your custom gradient colors */}
              ...
              <div className="relative group">
                ...
                >
                  <div className="mb-6">
                    ...
                    >
                      <svg className="w-7 h-7" style={{ color: uniTalentColors.text }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                      </svg>
                    </div>
                    <h3 style={{ color: uniTalentColors.text }} className="text-2xl font-bold mb-3">
                      The Silence
                    </h3>
                  </div>
                  <p style={{ color: uniTalentColors.text }} className="text-lg opacity-80 leading-relaxed">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <button 
                style={{ 
                  ...
                  boxShadow: `0 10px 30px ${uniTalentColors.primary}66`,
                }}
            ...
            <div 
              style={{ 
                backgroundColor: uniTalentColors.background,
                borderColor: uniTalentColors.primary,
                boxShadow: `0 8px 25px ${uniTalentColors.primary}26`,
              }}
              className="inline-flex items-center gap-8 px-8 py-6 rounded-2xl border-2"
            >
              <div className="text-center">
                <div style={{ color: uniTalentColors.text }} className="text-3xl font-bold">5,000+</div>
                <div style={{ color: uniTalentColors.text }} className="text-sm opacity-80">PMs Transformed</div>
              </div>
              <div 
              ...
              ></div>
              <div className="text-center">
                <div style={{ color: uniTalentColors.text }} className="text-3xl font-bold">3.2x</div>
                <div style={{ color: uniTalentColors.text }} className="text-sm opacity-80">More Interviews</div>
              </div>
              <div 
                style={{ backgroundColor: uniTalentColors.primary }}
                className="h-10 w-px"
              ></div>
              <div className="text-center">
                <div style={{ color: uniTalentColors.text }} className="text-3xl font-bold">85%</div>
                <div style={{ color: uniTalentColors.text }} className="text-sm opacity-80">Success Rate</div>
              </div>
            </div>
          </div>
        </div>
